# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-03-07 20:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.URLField()),
                ('score', models.FloatField()),
                ('recommended_for', models.CharField(choices=[('nr', 'Not recommended'), ('it', 'Italy'), ('cn', 'China'), ('in', 'India'), ('pt', 'Brazil'), ('ww', 'World Wide')], default='nr', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Quality',
