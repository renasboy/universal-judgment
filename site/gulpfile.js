...
gulp.task('build:prod', gulp.series('partials', gulp.parallel('inject', 'other'), 'build', 'replace-api-url-prod'));
gulp.task('build:test', gulp.series('partials', gulp.parallel('inject', 'other'), 'build'));
